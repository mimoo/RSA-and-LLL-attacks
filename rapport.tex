...
\toprule
 \multicolumn{1}{c}{$\delta$} & size of $N$ & size of $d$ & X & Y & m & t & time \\ 
\midrule
 0.26 & 1024 & 256 & $\lfloor 2N^\delta \rfloor$ & $\lfloor N^{\frac{1}{2}} \rfloor$ & 3 & 1 & 0.8s\\ 
 0.26 & 2048 & 532 & $\lfloor 2N^\delta \rfloor$ & $\lfloor N^{\frac{1}{2}} \rfloor$ & 3 & 1 & 1.9s \\
 0.27 & 2048 & 553 & $\lfloor 2N^\delta \rfloor$ & $\lfloor N^{\frac{1}{2}} \rfloor$ & 6 & 3 & 3m 3s \\
 0.28 & 1024 & 553 & $\lfloor 2N^\delta \rfloor$ & $\lfloor N^{\frac{1}{2}} \rfloor$ & 6 & 3 & 3m 3s \\
\bottomrule
\end{tabular}
\end{center} 
