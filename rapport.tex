...
We can now develop the previous equation bounding the detemrinant, and we fix $t = \tau m$:

\[ X^{\frac{1+\tau}{3}m^3}Y^{(\frac{\tau^2 +1}{6}+ \frac{\tau}{3})m^3} e^{(\frac{1}{3} + \frac{\tau}{6})m^3} < e^{(\frac{1}{2} + \frac{\tau}{2})m^2} \text{ for } m \rightarrow \infty \]

We then inject $X = N^\delta$ and $Y = N^{\frac{1}{2}}$ in the previous equation:
\[(2N^\delta)^{\frac{1+\tau}{3}m^3}(N^{\frac{1}{2})^{(\tau+1)^2}{6}m^3}e^{(\frac{\tau+2}{6})m^3} < e^{\frac{1+\tau}{2}m^3} \]

Boneh and Durfee derived an optimized value of $\tau = (1 - 2\delta)$ and the \textbf{Boneh-Durfee bound}:
