...
My experiments were far from Boneh and Durfee's findings. I found out that I couldn't find any results for $d > N^0.267$. And that in practice, the bound of $X$ was often way higher than the root $x_0$, decreasing $X$ until the algorithm worked was efficient. Also my implementation ran in a few seconds/minutes whereas Boneh and Durfee's took several hours. I used Sage in a Virtualbox with 512Mo of RAM, 1 core from an Intel i7 @ 2.30GHz
