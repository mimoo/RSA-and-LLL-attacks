...
We've seen how Coppersmith found a way of using lattices and the LLL algorithm to find small roots to particular univariate polynomials. What about problems that have two unknowns? Coppersmith gave an heuristic for finding roots of bivariate polynomials but left it at that. More recently, Boneh and Durfee released papers on RSA attacks using the initial ideas of Coppersmith for finding small roots of bivariate polynomials.
