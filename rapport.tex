...
To achieve their \textbf{improved results} of $d < N^{0.292}$, they created the concepts of Geometrically Progressive Matrices and showed that by \textbf{removing some of the y-shifts}, the bounds on the shortest vector found by LLL were improved. Unfortunately by doing this we \textbf{lose the triangular structure} of the basis and computing the determinant of the new rectangular basis is tricky. This is where \textbf{Herrmann and May} intervene.
