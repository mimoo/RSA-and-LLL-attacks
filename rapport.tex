...
\draw [ultra thick,black] [->] (11,5) -- (12,5);
...
\draw [fill] (9,7) circle [radius=0.1];
...
\draw [fill] (3,7) circle [radius=0.1];
\draw [fill] (4,8) circle [radius=0.1];
\draw [fill] (5,9) circle [radius=0.1];

\draw [fill] (1,7) circle [radius=0.1];
\draw [fill] (2,8) circle [radius=0.1];
\draw [fill] (3,9) circle [radius=0.1];

\draw [fill] (1,9) circle [radius=0.1];
\end{tikzpicture}
\end{figure}
