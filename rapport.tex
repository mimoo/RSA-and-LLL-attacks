...
% diagram of three messages being encrypted
...
My experiments were far from Boneh and Durfee's findings. I found out that in practice, I couldn't find any results for $d > N^0.27$. And that in practice, the bound of $X$ was often way higher than the root $x_0$, decreasing $X$ until the algorithm worked was a good way to find the roots. Also my implementation ran in a few seconds/minutes whereas Boneh and Durfee's took several hours. I used Sage 6.4 in a Virtualbox with 512Mo of RAM, 1 core from an Intel i7 @ 2.30GHz

\begin{center} 
\begin{tabular}{@{} l *7c @{}}
\toprule
 \multicolumn{1}{c}{$\delta$} & size of $N$ & size of $d$ & X & Y & m & t & time \\ 
\midrule
 0.26 & 1024 & 256 & $\lfloor 2N^\delta \rfloor$ & $\lfloor N^{\frac{1}{2}} \rfloor$ & 3 & 1 & 0.3s\\ 
 0.26 & 2048 & 532 & $\lfloor 2N^\delta \rfloor$ & $\lfloor N^{\frac{1}{2}} \rfloor$ & 3 & 1 & 0.6s \\
 0.27 & 2048 & 553 & $\lfloor 2N^\delta \rfloor$ & $\lfloor N^{\frac{1}{2}} \rfloor$ & 7 & 3 & 11m \\
\bottomrule
\end{tabular}
\end{center} 
