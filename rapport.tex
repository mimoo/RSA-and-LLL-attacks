...
As for vector spaces, lattices can also be described by many different basis represented as \textbf{matrices}. Contrary to vector spaces, we generally represent the vectors of the basis as \textbf{rows} in their corresponding matrices.\\
...
We will not see how LLL works here, see Chris Peikert's course\cite{chrispeikert} for a detailed view of the algorithm.
